...
import {modes,drawLifeTopic,castCoins,hexagram,liuren,hours,palaces,drawTarot,castDice,planets,planetExamples,zodiacElements,houseGroups,signs,houses,type DrawnCard} from '@/lib/oracle';
...
export default function OracleExperience(){
 ...
 {result?.kind==='tarot'&&<div className="reflection"><small>把牌当作一个提问</small><p>{result.cards.length===3?'这些线索与你的处境有哪些呼应？选择一个最小的、能亲自验证的行动。':'这张牌让你首先想起什么？那可能是此刻值得留意的感受。'}</p></div>}
